...
function draw() {   //Main loop
    ...
    som1.nodes[x + y * constNumCellsAcross].m_dWeights.forEach((weight, index) => {
        index == 0 ? text('0', 270, constWindowHeight + 70 + index * 30, constWindowWidth, 30) : 1;
        index == 1 ? text('1', 270, constWindowHeight + 70 + index * 30, constWindowWidth, 30) : 1;
        index == 2 ? text('2', 270, constWindowHeight + 70 + index * 30, constWindowWidth, 30) : 1;
